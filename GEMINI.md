...
- **Go Conventions:** Standard directory structure (`cmd/`, `pkg/`).
...
- `pkg/embedder/`: SigLIP normalization and T5Gemma 2 encoder logic.
- `pkg/db/`: Postgres schema, HNSW indexing, and BYTEA/JSONB handling.
- `pkg/rag/`: Retrieval (vector search) and Generation (Gemma 2 decoder) orchestration.
